...
@section('title', 'Crear Prima de Profesionalización')

@section('header', 'Crear Prima de Profesionalización')

@section('content')
<div class="bg-white shadow-md rounded-lg overflow-hidden">
    <div class="py-4 px-6 bg-gray-100 border-b">
        <h2 class="text-xl font-semibold text-gray-800">Nueva Prima de Profesionalización</h2>
    </div>

    <div class="py-4 px-6">
        <form action="{{ route('prima-profesionalizacion.store') }}" method="POST">
            @csrf

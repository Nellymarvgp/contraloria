...
@section('header', 'Crear Nuevo Departamento')

@section('content')
<div class="max-w-4xl mx-auto py-6">
    <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <form action="{{ route('departamentos.store') }}" method="POST" id="createDepartamentoForm" novalidate>
            @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    const form = document.getElementById('createDepartamentoForm');
